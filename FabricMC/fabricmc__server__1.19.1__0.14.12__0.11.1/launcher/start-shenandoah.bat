...
for /F "eol=# delims== tokens=1,*" %%a in (../launcher/config-shenandoah.properties) do (
...
set commandline=%commandline% "../fabric-server-mc.1.19.1-loader.0.14.12-launcher.0.11.1.jar"
