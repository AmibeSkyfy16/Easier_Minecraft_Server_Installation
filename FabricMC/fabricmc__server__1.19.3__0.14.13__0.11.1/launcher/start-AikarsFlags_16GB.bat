...
for /F "eol=# delims== tokens=1,*" %%a in (../launcher/config-AikarsFlags_16GB.properties) do (
...
set commandline=%commandline% "../fabric-server-mc.1.19.3-loader.0.14.13-launcher.0.11.1.jar"
